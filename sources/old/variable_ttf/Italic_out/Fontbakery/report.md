...
* 🔥 **FAIL** The file 'Rubik_Italic-VF.ttf' must be renamed to 'Rubik-Italic[wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* 🔥 **FAIL** The following glyph names do not comply with naming conventions: finalpedageshhebrew.black.black.001
